...
setwd("C:/Users/ailene.ettinger/Documents/GitHub/grit")
...
#aq_locs<-read.csv("data/PurpleAir/GRIT_AQ_Monitors_Survey.csv", header=TRUE) 
...
#lc <-  raster("~/Documents/Land Cover/psLandCover_mosaic.tif")
...
etacrect <- as(raster::extent(530000, 555000, 5220000, 5240000), "SpatialPolygons")

lc_tacrect<-crop(x = lc, y =etacrect )
plot(lc_tacrect, 
...
png("analyses/figs/tacomaqlcmap.png", width=12, height=12, units="in", res=220)

plot(lc_tacoma, 
     main = "Tacoma landcover", col=c("springgreen","springgreen4","darkgreen","chocolate","skyblue","gray","darkgray"))
plot(locs, add=TRUE, col="black", pch=16, cex=1.5)
plot(locs, add=TRUE, col="red", pch=1, cex=3)
plot(locs, add=TRUE, col="red", pch=1, cex=5)
plot(locs, add=TRUE, col="red", pch=1, cex=7)
plot(locs, add=TRUE, col="red", pch=1, cex=9)

dev.off()

#look at it just to check:
png("analyses/figs/gritlcmap_aq2024.png", width=12, height=12, units="in", res=220)

plot(lc_grit, 
     main = "GRIT landcover", col=c("springgreen","springgreen4","darkgreen","chocolate","skyblue","gray","darkgray"))

plot(locs, add=TRUE, col="black", pch=16, cex=1.5)
text(locs, add=TRUE, col="black", pch=locs$Purple.Air.Name, cex=1.5)
